 ...
 **/
class RightFollowerAdapterDelegate : AdapterDelegate<FollowersViewModelHolder> {

    private var listener: OnRightFollowerClickListener? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        val view = inflater.inflate(R.layout.follower_item_right, parent, false)
    ...
    private fun callOnFollowerClickIfNotNull(follower: Follower) {
        listener?.onClick(RightFollowerClickdata(follower.htmlUrl))
    }

    fun setOnFollowerClickListener(listener: OnRightFollowerClickListener) {
